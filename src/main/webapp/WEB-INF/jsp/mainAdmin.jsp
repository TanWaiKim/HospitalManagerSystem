...
<body style="background-color: #f2f9fd;">
	...
	<div class="leftnav " style="overflow:scroll;">
		...
		<h2>
			<span class="icon-cog"></span>医生信息管理
		</h2>
		<ul style="display: none">
		...
		<ul style="display: none">
			<li><a href="${pageContext.request.contextPath }/medicalcourses/list" target="right"><span
					class="icon-caret-right"></span>科别管理</a></li>
		</ul>
		
		<h2>
			<span class="icon-cog"></span>病床管理
		</h2>
		<ul style="display: none">
		...
		<h2>
			<span class="icon-cog"></span>住院信息管理
		</h2>
		<ul style="display: none">
		...
		<ul style="display: none">
			...
			<li><a href="${pageContext.request.contextPath }/notice/alist" target="right"><span
