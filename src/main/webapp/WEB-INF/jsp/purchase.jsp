...
<body>
	<form method="post"
		action="${pageContext.request.contextPath }/statistics/purchaseByCondition"
		id="listform">
		<div class="panel admin-panel">
			<div class="padding border-bottom">
				...
				<ul class="search" style="padding-left: 10px;">
					<li>
						医药名称
						<input type="text" placeholder="请输入医药名称" name="drugName" value="${drugName }" style= "width:120px"/>  
					</li>
					<li>
						批准文号
						<input type="text" placeholder="请输入批准文号" name="drugNo" value="${drugNo }" style= "width:120px"/>  
					</li>
					<li>
						开始时间
