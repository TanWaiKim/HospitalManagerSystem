			...
			<div class="padding border-bottom">
				...
				<ul class="search" style="padding-left: 10px;">
					<li><a class="button border-main icon-plus-square-o"
						href="${pageContext.request.contextPath }/notice/skipToAdd">
							添加公告</a></li>
					<li>搜索：</li>
				 ...
				 <c:forEach
					...
					<tr>
						<td style="text-align: left; padding-left: 20px;"><input
							type="checkbox" name="id[]" value="${notice.id}" /><span>${(page.currentPage-1)*3+status.count}</span>
						</td>
						...
						<td><div class="button-group">
								<a class="button border-main"
									href="${pageContext.request.contextPath }/notice/findById/${notice.id }"><span
									class="icon-edit"></span> 修改</a> <a class="button border-red"
									href="javascript:judgeDelete('${notice.id}')"><span
