...
<body>
	<%   
 	...
 	%> 
	<form method="post"
		action="${pageContext.request.contextPath }/statistics/saleByCondition1"
		id="listform">
	...
	<script type="text/javascript">
        ...
        url : "${pageContext.request.contextPath }/statistics/sale2?drugName=${drugName}&&beginTime=${beginTime}&&endTime=${endTime}", //请求发送到Controller处
        data : {},
