...
<body>
	...
	<div class="panel">
		<div class="panel-head">
			<strong>特殊病人详细信息</strong>
		</div>
		<table class="table">
			<tbody>
				<tr>
					<td style="width:300px;height:50px;border:1px solid cadetblue;">病人编号：</td>
					<td style="height:50px;border:1px solid cadetblue;">${patient.patientId }</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="height:50px;border:1px solid cadetblue;">人群类型：</td>
					<td style="height:50px;border:1px solid cadetblue;">${patient.personType }</td>
				</tr>
				<tr>
